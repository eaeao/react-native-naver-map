...
{
  if (json == nil) [view.mapView setLayerGroup:NMF_LAYER_GROUP_TRANSIT isEnabled: NO];
  [view.mapView setLayerGroup:NMF_LAYER_GROUP_TRANSIT isEnabled: [json boolValue]];
}
