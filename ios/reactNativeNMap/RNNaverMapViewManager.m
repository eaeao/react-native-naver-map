...
{
  if (json == nil) [view.mapView setLayerGroup:NMF_LAYER_GROUP_BICYCLE isEnabled: NO];
  [view.mapView setLayerGroup:NMF_LAYER_GROUP_BICYCLE isEnabled: [json boolValue]];
}
